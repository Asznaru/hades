...
<template>
    <div class="border border-gray-600 px-8 my-8 w-[75%] mx-auto">
      ...
      <div class="mb-2 text-left text-gray-500">Network Status: <span class="text-emerald-500">ACTIVE</span> | Encryption: AES-256 | Active Feeds: <span class="text-rose-500">1/4</span></div>
      <div class="grid grid-rows-2 grid-cols-2 gap-1 mb-8">
        <!-- CAM-001 (OFFLINE) -->
        <div class="mx-auto border border-gray-600 bg-black text-red-500 w-[40rem] my-1 overflow-hidden">
          <div class="relative w-full pt-[56.25%]">
            ...
            <div class="absolute top-0 left-0 w-full flex justify-between items-center bg-black px-4 py-1 text-xs">
              <span class="font-mono">CAM-001</span>
        ...
        <div class="mx-auto border border-gray-600 bg-black text-red-500 w-[40rem] my-1 overflow-hidden">
          <div class="relative w-full pt-[56.25%]">
            ...
            <div class="absolute top-0 left-0 w-full flex justify-between items-center bg-black px-4 py-1 text-xs">
              <span class="font-mono">CAM-002</span>
              <span class="text-red-500 font-mono">OFFLINE</span>
            </div>
        ...
        <div class="mx-auto border border-gray-600 bg-black text-red-500 w-[40rem] my-1 overflow-hidden">
          <div class="relative w-full pt-[56.25%]">
            ...
            <div class="absolute top-0 left-0 w-full flex justify-between items-center bg-black px-4 py-1 text-xs">
              <span class="font-mono">CAM-003</span>
              <span class="text-red-500 font-mono">OFFLINE</span>
            </div>
        ...
        <!-- CAM-004 (ONLINE) -->
        <div class="mx-auto border border-gray-600 bg-black text-emerald-500 w-[40rem] my-1 overflow-hidden">
          <div class="relative w-full pt-[56.25%]">
            <!-- iframe -->
            <iframe
            ...
            <!-- Overlay: górny pasek -->
            <div class="absolute top-0 left-0 w-full flex justify-between items-center bg-black px-4 py-1 text-xs">
              <span class="font-mono">CAM-004</span>
